 ...
 */
class Version20171218054652 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql(
            'CREATE TABLE children (id UUID NOT NULL, family_id UUID NOT NULL, name VARCHAR(255) NOT NULL, avatar_uri VARCHAR(255) DEFAULT NULL, color CHAR(7) DEFAULT NULL, access_code CHAR(6) DEFAULT NULL, created TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))'
        );
